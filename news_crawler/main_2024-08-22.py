...
class NewsCollectorApp:
    ...
    def create_appbar(self):
        self.default_appbar_color = ft.colors.BROWN_300  # 기본 AppBar 색상
        ...
        for cnt in range(100, 106):
            ...
            for line in li_link:
                ...
                try:
                    ...
                    log_error_to_file(error_message)  # 에러 로그를 파일에 기록
